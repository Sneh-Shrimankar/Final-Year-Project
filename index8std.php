...
<body style="background-color:#cad7fda4">
            ...
            <div class="col-md-12 mt-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Select 8th STD Excel file to upload data into database</h4>
                    </div>
                    <div class="card-body">

                        <form action="code8th.php" method="POST" enctype="multipart/form-data">
