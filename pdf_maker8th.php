<?php                
require 'database_connection8th.php'; 
require_once 'vendor/autoload.php';

$MST_ID=$_GET['id'];

$inv_mst_query = "SELECT T1.id,T1.Roll_No,T1.Stu_Name,T1.Stu_ID,T1.PEN_No,T1.GR_No,T1.Division,T1.FLT,T1.FLMIN,T1.FLR,T1.SLT,T1.SLMIN,T1.SLR,T1.TLT,T1.TLMIN,T1.TLR,T1.MathTot,T1.MathMin,T1.MathRe,
T1.SciTot,T1.SciMin,T1.SciRe,T1.SoSciTot,T1.SoSciMin,T1.SoSciRe,T1.DrawG,T1.DrawMin,T1.DrawRe,T1.WEG,T1.WEGMin,T1.WERe,T1.PEG,T1.PEGMin,T1.PERe,T1.Percen,T1.ReDate,T1.Remark FROM 8_std_data T1 WHERE T1.id='".$MST_ID."' ";             
  ...
  <table border="0.5">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>     '.$inv_mst_data_row['SLT'].'</td>
        <td>     '.$inv_mst_data_row['SLR'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>     '.$inv_mst_data_row['TLT'].'</td>
        <td>     '.$inv_mst_data_row['TLR'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>     '.$inv_mst_data_row['MathTot'].'</td>
        <td>     '.$inv_mst_data_row['MathRe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        <td>5</td>
        <td> Science</td>
        <td>     '.$inv_mst_data_row['SciMin'].'</td>
        <td>     '.$inv_mst_data_row['SciTot'].'</td>
        <td>     '.$inv_mst_data_row['SciRe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>     '.$inv_mst_data_row['SoSciMin'].'</td>
        <td>     '.$inv_mst_data_row['SoSciTot'].'</td>
        <td>     '.$inv_mst_data_row['SoSciRe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>     '.$inv_mst_data_row['DrawG'].'</td>
        <td>     '.$inv_mst_data_row['DrawRe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        <td >8</td>
        <td > WE(Computer)</td>
        <td>     '.$inv_mst_data_row['WEGMin'].'</td>
        <td>     '.$inv_mst_data_row['WEG'].'</td>
        <td>     '.$inv_mst_data_row['WERe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
    ...
    <tbody>
      ...
      <tr>
        <td >8</td>
        <td > Phy.Education</td>
        <td>     '.$inv_mst_data_row['PEGMin'].'</td>
        <td>     '.$inv_mst_data_row['PEG'].'</td>
        <td>     '.$inv_mst_data_row['PERe'].'</td>
      </tr>
      <!-- Repeat for other subjects -->
    </tbody>
